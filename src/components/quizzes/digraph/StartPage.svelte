...
<div>
  ...
  <div class="flex gap-2 mb-4">
    <label for="N" class="">Hide Colours: </label>
    <input type="checkbox" id="hideColor" bind:checked={hideColor} class="dark:bg-gray-700 rounded-md p-2 my-auto" />
  </div>
