...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      await axios.post(`${import.meta.env.PUBLIC_MM}/api/apps/meetup-maker/dates/${this.id}`, {
        name: this.name,
    ...
    async handleConfirm() {
      ...
      await axios.post(`${import.meta.env.PUBLIC_MM}/api/apps/meetup-maker/confirm_date/${this.id}`, {
