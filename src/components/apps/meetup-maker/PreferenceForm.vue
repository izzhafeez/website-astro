...
export default {
  ...
  methods: {
    ...
    async handleSubmitPreferences() {
      ...
      await axios.post(`${import.meta.env.PUBLIC_MM}/api/apps/meetup-maker/preferences/${this.id}`, {
        name: this.name,
        startTime: this.startTime,
        endTime: this.endTime,
        startLat: this.startLat,
    ...
    async handleGenerateRecommendations() {
      ...
      await axios.post(`${import.meta.env.PUBLIC_MM}/api/apps/meetup-maker/recommend/${this.id}`, {
        name: this.name
      }).then(response => {
        return response.data;
      }).then(data => {
    ...
    async handleLike(rec) {
      ...
      await axios.post(`${import.meta.env.PUBLIC_MM}/api/apps/meetup-maker/like/${this.id}`, {
        name: this.name,
        timing: rec.timing,
    ...
    async handleConfirm() {
      ...
      await axios.post(`${import.meta.env.PUBLIC_MM}/api/apps/meetup-maker/confirm_timing/${this.id}`, {
        timing: this.timing,
        location: this.location
      }).then(response => {
        return response.data;
      }).then(_ => {
        window.location.href = `/apps/meetup-maker/meetup/?id=${this.id}`
      });
    }
  }
}
