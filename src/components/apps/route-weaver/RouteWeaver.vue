...
import parksData from "../../../data/apps/route-weaver/parks.json";
import touristData from "../../../data/apps/route-weaver/tourist-attractions.json";
import monumentsData from "../../../data/apps/route-weaver/monuments.json";
import mrtData from "../../../data/apps/route-weaver/mrt.json";
