...
function BurningBridgesRoomCreate() {
  ...
  const showInstructions = () => {
    Swal.fire({
      ...
      html: `<div class="text-left grid grid-cols-[auto_1fr] gap-2">
        ${gamesData['burning-bridges'].instructions.map((line, index) => `<span><b>Step ${index}</b></span></span>${line}</span>`).join('')}
      </div>
      `,
  ...
  return (
    <div className="p-2">
      <div className="p-4 md:p-6 rounded-3xl shadow-md max-w-3xl mt-60 mx-auto bg-ns-500/50">
