...
function DataHedgerRoomCreate({ title, instructions }: { title: string, instructions: string }) {
  ...
  return (
    ...
    <div className="p-2 max-w-6xl mx-auto">
      <div className="mt-40 text-center">
        ...
        <p className="max-w-3xl mx-auto mb-4 ">{gamesData['data-hedger'].heroText} {instructions} Deck: <span className="text-dt-500 dark:text-dt-200 font-bold">{title}</span></p>
